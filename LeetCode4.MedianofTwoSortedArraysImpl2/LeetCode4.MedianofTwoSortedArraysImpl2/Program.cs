...
namespace LeetCode4.MedianofTwoSortedArraysImpl2
{
    class Program
    {
        ...
        {
            var s = new Solution();
            //var r = s.FindMedianSortedArrays(new int[] { 1, 2, 3 }, new int[] { 4, 5, 6});
            //var r = s.FindMedianSortedArrays(new int[] { 1000000 }, new int[] { 1000001 });
            var r = s.FindMedianSortedArrays(new int[] { 1, 2 }, new int[] { 3 });
        }
        ...
        public class Solution
        {
            ...
            private double FindMedianSortedArrays(int[] n1, int l1, int r1, int[] n2, int l2, int r2)
            {
                var s1 = r1 - l1 + 1;
                var s2 = r2 - l2 + 1;
                if (s1 == 2 && s2 == 2)
            ...
            private double CalcMedianOfArray(int[] a, int l, int r, ref int m)
            {
                if (l >= r) return a[l];
